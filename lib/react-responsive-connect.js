              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (args && args.req) {
                    ...
                    console.log('react-responsive-connect detectedMediaType', detectedMediaType);
                    console.log('react-responsive-connect detectedMediaWidth', detectedMediaWidth);
                    console.log('react-responsive-connect args.req', _safeJsonStringify(args.req));
