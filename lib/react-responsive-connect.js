  ...
  return _temp = _class = function (_React$Component) {
    ...
    (0, _createClass2.default)(ReactResponsiveNextHoc, null, [{
      ...
      value: function updateDeviceTypeByViewportSize() {
        ...
        var previouslyDetectedMediaWidth = _isomorphicCookie.default.load('detectedMediaWidth');
        ...
        if (!previouslyDetectedMediaWidth) {
          var initialWidth = _isomorphicCookie.default.load('initialMediaWidth');
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (args && args.req) {
                    ...
                    console.log('react-responsive-connect', { detectedMediaType, detectedMediaWidth, url: args.req.url, headers: args.req.headers });
                ...
                case 12:
                  var myargs = _args.length > 0 && _args[0] !== undefined ? _args[0] : {};
                  console.log('react-responsive-connect2', { fakeWidth: newProps.env.detectedMediaWidth, url: myargs.req.url});
