...
var MediaQueryWrapper = function MediaQueryWrapper() {
  ...
  return _react.default.createElement(_reactResponsive.default, (0, _extends2.default)({}, other, {
    ...
    if (props.debug) {
      console.log('ShowComponent lib matches', matches, props.query, props.name, MediaQueryWrapper.fakeWidth);
      console.log('ShowComponent lib config', _reactResponsiveConnect.ReactResponsiveConnect.customConfig || _defaultConfig.defaultConfig, props.name);
    }
    if (matches) {
