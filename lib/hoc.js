  ...
  return _temp = _class = function (_React$Component) {
    (0, _createClass2.default)(ReactResponsiveNextHoc, null, [{
      ...
      value: function getDefaultMediaWidthByType(mediaType) {
        var media = (0, _media.getMedia)(hoc.customConfig || _defaultConfig.defaultConfig);
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  newArgs = (0, _objectSpread2.default)({}, args, newProps);
    ...
    function ReactResponsiveNextHoc(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ReactResponsiveNextHoc).call(this, props));
    ...
    config: hoc.customConfig || _defaultConfig.defaultConfig
  }, _temp;
};
